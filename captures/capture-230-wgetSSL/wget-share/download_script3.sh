...
WEBSITE=${SITE#*,}
HTTPS=https://$WEBSITE
wget --recursive -l 5 --page-requisites --connect-timeout=10 --tries=5 --html-extension --convert-links --header "User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.157 Safari/537.36" --header "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8" --header "Accept-Language: en-US,en;q=0.5" --header "Accept-Encoding: gzip, deflate" --ca-certificate $CERT $HTTPS -P /downloads
done
